...
# Fix building with berkeley db 4.8 on Fedora 20
...
Patch184: 00184-ctypes-should-build-with-libffi-multilib-wrapper-2.6.patch

# 4587
# Fix for http://bugs.python.org/issue4587
# add --with-dbmliborder option
Patch4587: Python-2.7.3-dbmliborder.patch
...
%changelog
* Thu May 15 2014 Rick Sherman <rick@shermdog.com> - 2.6.5-18
- Rebuilt for Fedora 20
- Patched BDB (patch 126)
- Patched for internal libffi (patch184)
- Turned off debug build (I don't need it and it's broken)
